//  Copyright (c) 2002-2015 Anthony Williams
//
//  Distributed under the Boost Software License, Version 1.0. (See accompanying
//  file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)

/// \file parallel/algorithms/detail/tuple_iterators.hpp
//
// Note : The code in this file was originally tupleit.hh from Anthony Williams'
// web site released without copyright. http://pastebin.com/LFkTHdQk
// if this information is incorrect, please advise us
...
namespace hpx {
    namespace iterators {
        namespace detail {
            ...
            static difference_type doDiff(boost::tuples::cons <ValueType, boost::tuples::null_type> const &lhs,
                                          boost::tuples::cons <ValueType, boost::tuples::null_type> const &rhs) {
...
//     };
        ...
        private:
            enum {
                categorySize = sizeof(hpx::iterators::detail::categoryCheck(false ? (Cat1 *) 0 : (Cat2 *) 0))
            };
        public:
...
// which may point to data within the tuple, or external to it
    ...
    namespace detail {
        ...
        const typename DerefIterTupleHelperKeepRef<IterTuple>::Type derefIterTupleKeepRef(IterTuple &iters) {
            return typename DerefIterTupleHelperKeepRef<IterTuple>::Type(*iters.template get<0>(),
                                                                         derefIterTupleKeepRef(iters.get_tail()));
        }
        ...
        typename DerefIterTupleHelperNoRef<IterTuple>::Type derefIterTupleNoRef(IterTuple &iters) {
            return typename DerefIterTupleHelperNoRef<IterTuple>::Type(*iters.template get<0>(),
                                                                       derefIterTupleNoRef(iters.get_tail()));
        }
        ...
        public:
            ...
            static void construct(Type *p, IterTuple const &iters) {
                ...
                new(p) Type(derefIterTupleKeepRef(iters), hpx::iterators::detail::PreserveReferences());
            }
...
//     }
    ...
    TupleIt<typename boost::tuples::tuple<Iter1, Iter2, Iter3, Iter4> > makeTupleIterator(Iter1 i1, Iter2 i2, Iter3 i3,
                                                                                          Iter4 i4) {
